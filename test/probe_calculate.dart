...
void main() async {
  ...
  final email = 'test_calc_${DateTime.now().millisecondsSinceEpoch}@example.com';
  final password = 'Password123!';
  final name = 'Test Calc';
  ...
  final url = '$baseUrl/api/v1/calculator/session/$sessionId/calculate';

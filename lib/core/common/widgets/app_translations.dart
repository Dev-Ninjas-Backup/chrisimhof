...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'fr_FR': {
      ...
      'Choose reminder and analytics settings.': 'Choisissez les paramètres de rappel et d\'analyse.',
      'Choose your plan': 'Choisissez votre forfait',
      'Continue your rhythm plan from today.': 'Continuez votre programme de rythme dès aujourd\'hui.',
      'Create account': 'Créer un compte',
      ...
      'GLOBAL': 'GLOBAL',
      'Invalid purpose. Please try again.': 'Objectif invalide. Veuillez réessayer.',
      'Later': 'Plus tard',
      'Log in': 'Se connecter',
      'No active workout session logged today.': 'Aucune séance d\'entraînement active enregistrée aujourd\'hui.',
      'No intake logged yet.': 'Aucune consommation enregistrée pour le moment.',
      ...
      'Your rhythm, rebuilt around real life.': 'Votre rythme, reconstruit autour de la vraie vie.',
      'Log out': 'Déconnexion',
      'Protect your account': 'Protégez votre compte',
      'Use a unique password with at least 8\ncharacters.': 'Utilisez un mot de passe unique d\'au moins 8\ncaractères.',
      'min · Z1': 'min · Z1',
      'min · Z2': 'min · Z2',
      'min · Z3': 'min · Z3',
      'min · Z4': 'min · Z4',

...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'Drink type must be one of the following values: espresso, coffee, energy, tea, custom':
          'Drink type must be one of the following values: espresso, coffee, energy, tea, custom',
      'Failed to log caffeine': 'Failed to log caffeine',
      'Failed to update caffeine entry': 'Failed to update caffeine entry',
      'Cut-off': 'Cut-off',
      'protect tonight\'s sleep window.': 'protect tonight\'s sleep window.',
      'Cycling': 'Cycling',
      'D': 'D',
      ...
      'Target adjusted for activity': 'Target adjusted for activity',
      'This week': 'This week',
      ...
      'Verre': 'Glass',
      'Tasse': 'Cup',
      'Grande bouteille': 'Large bottle',
      'Eau': 'Water',
      'Water intake logged': 'Water intake logged',
      'Failed to log water': 'Failed to log water',
      'of': 'of',
      'MEALS OF THE DAY': 'MEALS OF THE DAY',
      ...
      'Meal consistency': 'Meal consistency',
      'Consistance du repas': 'Meal consistency',
      'Edit meal': 'Edit meal',
      'Modifier le repas': 'Edit meal',
      ...
      'Snack': 'Snack',
      'Collation': 'Snack',
      'Pre-work meal': 'Pre-work meal',
      'Repas avant le travail': 'Pre-work meal',
      'Repas': 'Meal',
      'repas': 'meals',
      ...
      'Supprimer la séance': 'Delete workout session',
      ...
      'Mixed': 'Mixed',
      'Autre': 'Other',
      'Nom de la boisson': 'Drink name',
      'Drink name': 'Drink name',
      'Quantité de caféine': 'Caffeine amount',
      'Caffeine amount': 'Caffeine amount',
      'Nom et quantité de caféine': 'Name and caffeine quantity',
      'Name and caffeine quantity': 'Name and caffeine quantity',
      'Ajouter de la caféine': 'Add caffeine',
      'Modifier la caféine': 'Edit caffeine entry',
      'Edit caffeine entry': 'Edit caffeine entry',
      'Supprimer la caféine': 'Delete caffeine entry',
      'Delete caffeine entry': 'Delete caffeine entry',
      'Consommée aujourd\'hui : ': 'Consumed today: ',
      'Consumed today: ': 'Consumed today: ',
      'Demi-vie ~ 5 h': 'Half-life ~ 5h',
      'Half-life ~ 5h': 'Half-life ~ 5h',
    },
    'fr_FR': {
      ...
      'Drink type must be one of the following values: espresso, coffee, energy, tea, custom':
          "Le type de boisson doit être l'une des valeurs suivantes : espresso, coffee, energy, tea, custom",
      ...
      'protect tonight\'s sleep window.': 'protégez votre fenêtre de sommeil ce soir.',
      'Cycling': 'Cyclisme',
      'D': 'D',
      ...
      'Volume d\'eau': 'Volume d\'eau',
      'Water volume': 'Volume d\'eau',
      'Date et heure': 'Date et heure',
      'Date and time': 'Date et heure',
      'Delete entry': 'Supprimer l\'entrée',
      'Supprimer l\'entrée': 'Supprimer l\'entrée',
      'Target adjusted for activity': 'Objectif ajusté à votre activité',
      'This week': 'Cette semaine',
      ...
      'Large': 'Grande bouteille',
      'Bouteille': 'Bouteille',
      'Verre': 'Verre',
      'Tasse': 'Tasse',
      'Grande bouteille': 'Grande bouteille',
      'Eau': 'Eau',
      'Water intake logged': 'Apport en eau enregistré',
      'Failed to log water': 'Échec de l\'enregistrement de l\'eau',
      'of': 'sur',
      'MEALS OF THE DAY': 'REPAS DU JOUR',
      'REPAS DU JOUR': 'REPAS DU JOUR',
      'Daily goal': 'Objectif quotidien',
      'Objectif quotidien': 'Objectif quotidien',
      'Add a meal': 'Ajouter un repas',
      'Ajouter un repas': 'Ajouter un repas',
      'Meal consistency': 'Consistance du repas',
      'Consistance du repas': 'Consistance du repas',
      'Edit meal': 'Modifier le repas',
      'Modifier le repas': 'Modifier le repas',
      'Delete meal': 'Supprimer le repas',
      'Supprimer le repas': 'Supprimer le repas',
      'Light meal': 'Repas léger',
      'Medium meal': 'Repas moyen',
      'Heavy meal': 'Repas lourd',
      ...
      'Snack': 'Collation',
      'Collation': 'Collation',
      'Pre-work meal': 'Repas avant le travail',
      'Repas avant le travail': 'Repas avant le travail',
      'Repas': 'Repas',
      'repas': 'repas',
      'Nouvelle séance': 'Nouvelle séance',
      'New session': 'Nouvelle séance',
      'Modifier la séance': 'Modifier la séance',
      'Edit session': 'Modifier la séance',
      'Supprimer la séance': 'Supprimer la séance',
      'Delete workout session': 'Supprimer la séance',
      ...
      'Mixed': 'Mixte',
      'Autre': 'Autre',
      'Nom de la boisson': 'Nom de la boisson',
      'Drink name': 'Nom de la boisson',
      'Quantité de caféine': 'Quantité de caféine',
      'Caffeine amount': 'Quantité de caféine',
      'Nom et quantité de caféine': 'Nom et quantité de caféine',
      'Name and caffeine quantity': 'Nom et quantité de caféine',
      'Ajouter de la caféine': 'Ajouter de la caféine',
      'Modifier la caféine': 'Modifier la caféine',
      'Edit caffeine entry': 'Modifier la caféine',
      'Supprimer la caféine': 'Supprimer la caféine',
      'Delete caffeine entry': 'Supprimer la caféine',
      'Consommée aujourd\'hui : ': 'Consommée aujourd\'hui : ',
      'Consumed today: ': 'Consommée aujourd\'hui : ',
      'Demi-vie ~ 5 h': 'Demi-vie ~ 5 h',
      'Half-life ~ 5h': 'Demi-vie ~ 5 h',
    },
  };
}

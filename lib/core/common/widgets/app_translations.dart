...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'Drink type must be one of the following values: espresso, coffee, energy, tea, other':
          'Drink type must be one of the following values: espresso, coffee, energy, tea, other',
      'Drink type must be one of the following values: espresso, coffee, energy, tea, custom':
          'Drink type must be one of the following values: espresso, coffee, energy, tea, other',
      'Drink name': 'Drink name',
      'Caffeine amount': 'Caffeine amount',
      'Name and caffeine amount': 'Name and caffeine amount',
      'Nom et quantité de caféine': 'Name and caffeine amount',
      'Edit Caffeine': 'Edit Caffeine',
      'Modifier la caféine': 'Edit Caffeine',
      ...
      'Rotation template saved!': 'Rotation template saved!',
      'Failed to save template': 'Failed to save template',
      'Disabling work rotation...': 'Disabling work rotation...',
      'Work rotation disabled': 'Work rotation disabled',
      'Failed to disable work rotation': 'Failed to disable work rotation',
      ...
      'mg active at bedtime — your recommended sleep time has been delayed by': 'mg active at bedtime — your recommended sleep time has been delayed by',
      'minutes to allow clearance.': 'minutes to allow clearance.',
    ...
    'fr_FR': {
      ...
      'Drink type must be one of the following values: espresso, coffee, energy, tea, other':
          "Le type de boisson doit être l'une des valeurs suivantes : espresso, coffee, energy, tea, other",
      'Drink type must be one of the following values: espresso, coffee, energy, tea, custom':
          "Le type de boisson doit être l'une des valeurs suivantes : espresso, coffee, energy, tea, other",
      'Drink name': 'Nom de la boisson',
      'Caffeine amount': 'Quantité de caféine',
      'Name and caffeine amount': 'Nom et quantité de caféine',
      'Nom et quantité de caféine': 'Nom et quantité de caféine',
      'Edit Caffeine': 'Modifier la caféine',
      ...
      'Rotation template saved!': 'Modèle de roulement enregistré !',
      ...
      'workouts this week': 'séances cette semaine',

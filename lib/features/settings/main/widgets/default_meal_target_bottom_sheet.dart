...
class DefaultMealTargetBottomSheet extends StatefulWidget {
  final SettingsController controller;

  const DefaultMealTargetBottomSheet({super.key, required this.controller});

  @override
  State<DefaultMealTargetBottomSheet> createState() =>
      _DefaultMealTargetBottomSheetState();
}

class _DefaultMealTargetBottomSheetState
    extends State<DefaultMealTargetBottomSheet> {
  late int _selectedCount;

  @override
  void initState() {
    super.initState();
    _selectedCount = widget.controller.defaultDailyMealTarget.value;
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                await widget.controller.updateDefaultMealTarget(_selectedCount);
              },

...
class SleepTaretBottomsheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void incrementHours() {
      if (controller.sleepHours.value < 23) {
        controller.sleepHours.value++;
      } else {
        controller.sleepHours.value = 0;
      }
    }
    ...
    void decrementHours() {
      if (controller.sleepHours.value > 0) {
        ...
        controller.sleepHours.value = 23;
      }
    }

    void incrementMinutes() {
      controller.sleepMinutes.value = (controller.sleepMinutes.value + 1) % 60;
    }

    void decrementMinutes() {
      controller.sleepMinutes.value = (controller.sleepMinutes.value - 1 + 60) % 60;
    }
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            controller.sleepMinutes.value.toString().padLeft(2, '0'),
                            style: getTextStyle2(
                              fontSize: 52,
                              fontWeight: FontWeight.w700,
                              color: AppColors.primaryTextColor,

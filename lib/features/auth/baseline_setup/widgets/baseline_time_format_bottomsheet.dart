...
class BaselineTimeFormatBottomsheet extends StatelessWidget {
  const BaselineTimeFormatBottomsheet({super.key});
            ...
            return Column(
              children: [
                _buildOptionTile(
                  ...
                  onTap: () {
                    controller.timeFormat.value = '24h';
                ...
                _buildOptionTile(
                  ...
                  onTap: () {
                    controller.timeFormat.value = '12h';
                    Navigator.of(context).pop();
                  },
                ),
              ],

...
class BaselineWeeklySportGoalBottomsheet extends StatefulWidget {
  const BaselineWeeklySportGoalBottomsheet({super.key});

  @override
  State<BaselineWeeklySportGoalBottomsheet> createState() =>
      _BaselineWeeklySportGoalBottomsheetState();
}

class _BaselineWeeklySportGoalBottomsheetState
    extends State<BaselineWeeklySportGoalBottomsheet> {
  ...
  void initState() {
    ...
    _selectedGoal = controller.weeklySportGoal.value;
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                controller.weeklySportGoal.value = _selectedGoal;

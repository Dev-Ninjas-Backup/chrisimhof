...
class EffortSelectionBottomsheet extends StatelessWidget {
  final RxString effort;

  const EffortSelectionBottomsheet({super.key, required this.effort});

  @override
  Widget build(BuildContext context) {
    final options = ['Very easy', 'Easy', 'Medium', 'Hard', 'Maximum'];
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...options.map((opt) {
            final isSelected = effort.value == opt;
